...
module.exports = {
  ...
  extends: ['eslint:recommended', 'plugin:vue/vue3-recommended', 'plugin:vue/vue3-essential', '@vue/eslint-config-typescript', 'plugin:vuejs-accessibility/recommended', 'plugin:storybook/recommended'],
  rules: {
